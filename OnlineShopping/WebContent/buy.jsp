...
<ul>
   ...
   <li><a href='#'><span>Contact</span></a></li>
       ...
       <tr><td bgcolor="#FF9900">Customer Email</td><td>  <input type="text" name="CustMailL"></td></tr>
       <tr><td bgcolor="#FF9900">Customer Address</td><td>  <input type="text" name="CustAdd"></td></tr>
